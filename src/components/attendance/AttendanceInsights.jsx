    ...
    >
      ...
      >
        ...
        <p className="mt-3 leading-7">
          Maintain at least <strong>{summary.targetPercentage}%</strong>{" "}
          attendance. Try not to skip Breakfast and Lunch, avoid unnecessary
          Extra Tiffin orders, and keep your Current Streak growing to improve

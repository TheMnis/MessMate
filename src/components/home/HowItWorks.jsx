...
const steps = [
  ...
  {
    id: 3,
    icon: <FaCalendarCheck className="text-5xl text-green-600" />,
  ...
  {
    id: 4,
    icon: <FaUtensils className="text-5xl text-green-600" />,
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mt-14">
          ...
          {steps.map((step) => (
            <div
              key={step.id}
              className="bg-slate-100 rounded-2xl p-8 text-center hover:shadow-xl transition"
            >
              <div className="flex justify-center mb-6">
                {step.icon}
              </div>

              <div className="w-10 h-10 bg-green-600 rounded-full text-white flex items-center justify-center mx-auto font-bold mb-5">
                {step.id}
              </div>
